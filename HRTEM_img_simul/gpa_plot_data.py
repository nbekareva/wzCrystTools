...
# gpa_folder = Path('/mnt/c/Users/a.walrave/Documents/M2 Internship & PhD/DataTreatment/HRTEM Titan/2024-05-14/ZnO_0001Zn_P3_HRTEM07_crop_1729x1131')
    ...
    if dir.is_dir() and dir.name.startswith("corepos"):
        ...
        if gpa_folder.exists():
            ...
            for i, f in enumerate(gpa_files):
                ...
                axs[2+i].imshow(img, cmap="RdBu", vmin=np.percentile(img, 5), vmax=np.percentile(img, 95))
